...
public class UserResModel {
    ...
    @Expose
    private Integer v;
    @SerializedName("tEarning")
    @Expose
    private String tEarning;
    @SerializedName("tcomplete")
    @Expose
    private Integer tcomplete;
    @SerializedName("yEarning")
    @Expose
    ...
    public Integer getTcomplete() {
        return tcomplete;
    }

    public void setTcomplete(Integer tcomplete) {
    ...
    public void setyEarning(String yEarning) {
